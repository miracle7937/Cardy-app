  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(children: [
        ...
        if(!profileController.userInfo.isKycVerified) SizedBox(height: Dimensions.PADDING_SIZE_SMALL,),

        if(!profileController.userInfo.isKycVerified) Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text('kyc_verification_is_not'.tr, style: rubikRegular.copyWith(color: Theme.of(context).errorColor),),
            CustomInkWell(
              onTap: (){
